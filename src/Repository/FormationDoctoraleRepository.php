...
class FormationDoctoraleRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(FormationDoctorale $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(FormationDoctorale $entity, bool $flush = true): void
    {
    ...
    // /**
    //  * @return FormationDoctorale[] Returns an array of FormationDoctorale objects
    //  */
    /*
    ...
    */
    ...
    /*
    public function findOneBySomeField($value): ?FormationDoctorale
    {
        return $this->createQueryBuilder('f')
            ->andWhere('f.exampleField = :val')
            ->setParameter('val', $value)
